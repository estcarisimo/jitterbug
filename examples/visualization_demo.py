...
from jitterbug.models import JitterbugConfig, MinimumRTTDataset, RTTDataset, RTTMeasurement
...
def create_min_rtt_data(raw_data: RTTDataset):
    ...
    return MinimumRTTDataset(measurements=min_measurements, interval_minutes=15)
...
def demonstrate_interactive_plots():
    ...
    try:
        ...
        timeline_fig = dashboard.interactive.create_interactive_timeline(
            raw_data, min_rtt_data, results, [], title="Demo Interactive Timeline"
        )
        ...
        dashboard_fig = dashboard.interactive.create_dashboard(
            raw_data, min_rtt_data, results, [], title="Demo Dashboard"
        )
        ...
        print("   💡 Open these files in your web browser to interact with them!")
