...
class AlgorithmSelector:
    ...
    def ask_question(self, question: str, options: list[str], default: str | None = None) -> str:
    ...
    def ask_number(
        self, question: str, min_val: float = None, max_val: float = None, default: float = None
    ) -> float:
    ...
    def gather_user_preferences(self):
        ...
        has_gpu = self.ask_yes_no("Do you have GPU resources available?", default=False)
        ...
        needs_interpretability = self.ask_yes_no(
            "Do you need highly interpretable results (e.g., for network research)?", default=False
        )
    ...
    def analyze_preferences(self):
        ...
        # Algorithm scoring
        algorithm_scores = {"ruptures": 0, "bcp": 0, "torch": 0}

        reasons = {"ruptures": [], "bcp": [], "torch": []}
        ...
        for algo, score in algorithm_scores.items():
            self.recommendations.append(
                {"algorithm": algo, "score": score, "reasons": reasons[algo]}
            )
    ...
    def generate_configuration(self, algorithm: str) -> dict[str, Any]:
        ...
        config = {"algorithm": algorithm, "threshold": 0.25, "min_time_elapsed": 1800}
    ...
    def generate_final_config(self, selected_algorithm: str):
        ...
        output_format = self.ask_question(
            "What output format would you prefer?", ["json", "csv", "parquet"], default="json"
        )
        ...
        full_config = {
            ...
            "latency_jump": {"threshold": 0.5},
            "data_processing": {"minimum_interval_minutes": 15, "outlier_detection": True},
