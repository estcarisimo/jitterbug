...
class JitterbugPlotter:
    ...
    def plot_change_points(
        ...
        for cp in change_points:
            ...
            ax.annotate(
                ...
                ha="center",
                bbox=dict(
                    boxstyle="round,pad=0.3", facecolor=self.colors["change_point"], alpha=0.3
                ),
            )
    ...
    def plot_algorithm_comparison(
        ...
        axes[0].plot(
            timestamps, values, label="RTT", color=self.colors["rtt"], linewidth=2, alpha=0.8
        )
        ...
        for i, (algorithm, change_points) in enumerate(algorithm_results.items()):
            ...
            ax.plot(timestamps, values, color="lightgray", linewidth=1, alpha=0.5)
    ...
    def plot_summary_statistics(
        ...
        axes[0, 0].plot(
            times, congestion_binary, marker="o", linewidth=2, color=self.colors["congestion"]
        )
