...
def analyze_algorithm(algorithm_name):
    ...
    try:
        ...
        jitter_significant = [
            ...
            if inf.jitter_analysis and inf.jitter_analysis.has_significant_jitter
        ]
        latency_jumps = [
            inf for inf in results.inferences if inf.latency_jump and inf.latency_jump.has_jump
        ]
